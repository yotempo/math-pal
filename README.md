...
- 📖 Story Solver：主題應用題，答錯給漸進式提示，可隨時「Ask Kai」讓 AI 引導思路；完成後可寫下解題過程讓 AI 批改思路（+2 分鼓勵，判分仍由程式碼負責）
- 🏆 Challenge Court：12 個關卡，星級評分 + 通關獎勵積分
- 🎯 每日任務：每天 3 個任務（練習量／應用題／連對／弱項主題輪替），完成自動加分；全完成有 sweep 獎勵；連續練習天數有 🔥 streak 加成
